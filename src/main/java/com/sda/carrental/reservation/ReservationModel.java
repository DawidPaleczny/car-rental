...
public class ReservationModel {
    ...
    public ReservationModel(Long id, String customer, CarModel car, LocalDate startDate, LocalDate endDate, BigDecimal price, BranchesModel startBranch, BranchesModel endBranch) {
        this.id = id;
